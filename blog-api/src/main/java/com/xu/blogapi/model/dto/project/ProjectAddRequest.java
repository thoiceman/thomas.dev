 ...
 */
@Data
@ApiModel(description = "项目添加请求")
public class ProjectAddRequest implements Serializable {

    /**
     * 项目名称
     */
    @ApiModelProperty(value = "项目名称", required = true, example = "博客系统")
     ...
     * 项目别名（URL友好）
     */
    @ApiModelProperty(value = "项目别名", required = true, example = "blog-system")
    @NotBlank(message = "项目别名不能为空")
    ...
    private Integer isOpenSource = 0;

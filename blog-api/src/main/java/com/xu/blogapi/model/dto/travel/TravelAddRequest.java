 ...
 */
@Data
@ApiModel(description = "旅行记录添加请求")
public class TravelAddRequest implements Serializable {

    /**
     * 旅行标题
     */
    @ApiModelProperty(value = "旅行标题", required = true, example = "日本关西之旅")
     ...
     * 目的地
     */
    @ApiModelProperty(value = "目的地", required = true, example = "日本关西")
     ...
     * 开始日期
     */
    @ApiModelProperty(value = "开始日期", required = true, example = "2024-03-01")
     ...
     * 结束日期
     */
    @ApiModelProperty(value = "结束日期", required = true, example = "2024-03-07")
